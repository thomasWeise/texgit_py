...
from latexgit.utils.strings import enforce_non_empty_str_without_ws, regex_sub
...
class Path(str):
    ...
    def is_dir(self) -> bool:
        ...
        :returns: `True` if this path identifies an existing directory, `False`
            otherwise.
        """
    ...
    def resolve_inside(self, relative_path: str) -> "Path":
        ...
        :raises ValueError: If the path would resolve to something outside of
            this path and/or sif it is empty.
        """
